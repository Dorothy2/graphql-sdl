insert into author(id, name, email) values('b8addf5e-43f8-4165-9a5f-ab73094a5b1e', 'Peter', 'peter@gmail.com');
insert into author(id, name, email) values('bffc75ba-c8e0-4178-93c9-20eb6cafed75', 'Harold', 'harold@gmail.com');
...
insert into post(id, title, description, category, author_id) values('7e759e91-a0d4-469b-ad81-50ba3969d211', 'JS','JS course - Johns post', 'IT', '44b0ed8f-351c-4368-a472-cadd17444947');

insert into comment(id, text, author_id, post_id) values('cb965e13-e95e-4fcd-9182-cb980269debe', 'Great book', '44b0ed8f-351c-4368-a472-cadd17444947', '7e759e91-a0d4-469b-ad81-50ba3969d211');
